...
val publication = "skema_scala"
val publicationNorm = "skema_scala"
...
ThisBuild / homepage := Some(url(s"https://github.com/robertvacareanu/$publicationNorm"))
...
ThisBuild / scmInfo := Some(
  ScmInfo(
    url(s"https://github.com/robertvacareanu/$publicationNorm"),
    s"scm:git@github.com:robertvacareanu/$publicationNorm.git"
  )
)
